...
import 'package:article_data/article_data_imports.dart' as _i445;
...
_i174.GetIt $initArticlesDomainDI(
  ...
  gh.factory<_i127.GetArticlesLocalUseCase>(
    () => _i127.GetArticlesLocalUseCase(gh<_i445.ArticleRepository>()),
  );
  gh.factory<_i978.GetArticlesRemoteUseCase>(
    () => _i978.GetArticlesRemoteUseCase(gh<_i445.ArticleRepository>()),
  );
  return getIt;
}
